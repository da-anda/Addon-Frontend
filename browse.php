...
$itemsperpage = 40;
$offset = 0;
if (isset($_GET['s'])) { $offset = intval($_GET['s']); }
...
if ($offset != 0) {
	$content .= '<a href="browse.php?t=' . htmlspecialchars($type) . '&s=' . $offsetback . '"/><img src="images/arrow-left.png" width="40" height="40" /></a><img src="images/transparent.png" width="40" height="40" />';
} else {
	$content .= '<img src="images/transparent.png" width="80" height="40" />';
}
...
if ($addonscount < $itemsperpage) {
	...
	$content .= '<a href="browse.php?t=' . htmlspecialchars($type) . '&s=' . $offsetforward . '"/><img src="images/arrow-right.png" width="40" height="40" /></a>';
}
$content .= '</div>';
